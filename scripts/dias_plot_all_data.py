...
class DIASPlotter(object):
    ...
    def plot_all(self, new_length=1000, k=3, reversed=True, x_scale=0.05, y_scale=3):
        ...
        for i in range(self.num_files):
            ...
            x1, y1_interaction = spline_data(x_rc, interaction_e, new_length=new_length, k=k)
        ...
        plt.ylabel(r'$E$ / kcal mol$^{-1}$', color='black', fontsize=12, fontweight='bold')
        plt.xlabel(r'Reaction coordinate / $\AA$', color='black', fontsize=12, fontweight='bold')

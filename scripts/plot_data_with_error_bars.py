...
@click.option('-ls', '--log-scale', type=bool, default=False, help='plot data in log scale, default False.')
...
@click.option('-xll', '--x-axis-labels', default=None, help='list of labels for customizing x-axis')
...
def entry_point(filename, save_folder, log_scale, labels_list, legend_loc, x_axis_labels, write_filename,
    ...
    plotter.plot_scatter_with_lines_and_error_bars(
        log=log_scale, data_labels_list=labels_list, legend_loc=legend_loc, x_axis_labels=x_axis_labels,
        xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax,
        xlabel=xlabel, ylabel=ylabel, title=title, legend=legend
    )
